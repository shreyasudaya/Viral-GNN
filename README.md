...
This code implements a deep learning model for classifying 10 COVID-19 variants using DNA sequences. The model architecture is specified in the Viral-GNN.py file. Training is conducted using the train_test_split function from the sklearn.model_selection module in splitset.py file, while the dataset is loaded through the Utils.py file.
